...
export default function MikrotikDevicesPage() {
    ...
    onSuccess: (res) => {
      ...
      if (test) {
        toast[test.success ? 'success' : 'error'](
          test.success
            ? `âœ… Conectado: ${test.identity} (RouterOS ${test.version})`
            : `âš ï¸ Creado pero sin conexiÃ³n: ${test.error}`
        );
      } else {
  ...
  const testConnection = async (id) => {
    ...
    try {
      ...
      qc.invalidateQueries(['devices-full']);
      if (r.success) {
        toast.success(`âœ… ${r.identity} â€” RouterOS ${r.version} (${r.uptime})`);
      } else {
        toast.error(`Sin conexiÃ³n: ${r.error}`);
      }
    } catch {
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            title="Configurar NAT para router remoto sin IP pÃºblica"
          >
          ...
          devices?.map(device => (
            <div key={device.id} className="card hover:shadow-md transition-shadow">
              ...
              <div className="text-xs text-gray-400 space-y-1 mb-4">
                ...
                {device.last_sync && <p>Ãšltima sync: {new Date(device.last_sync).toLocaleString('es')}</p>}
              </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              ...
              <div className="space-y-3">
                ...
                <div>
                  <label className="label">Zona geogrÃ¡fica</label>
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md">
            <div className="p-6">
              ...
              <p className="text-sm text-gray-500 mb-5 ml-11">
                Crea una regla de reenvÃ­o de puertos en el router gateway (online) para acceder al router remoto conectado por VPN.
              </p>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  >
                    ...
                    {onlineDevices.map(d => (
                      <option key={d.id} value={d.id}>{d.name} â€” {d.host}:{d.port}</option>
                    ))}
                  </select>
                ...
                <div>
                  ...
                  />
                  <p className="text-xs text-gray-400 mt-0.5">Visible en PPP â†’ Active del gateway</p>
                </div>
                ...
                <div>
                  <label className="label">Usuario PPP (para fijar IP estÃ¡tica)</label>
                  <input
                    className="input"
                ...
                <div className="bg-blue-50 rounded-xl p-3 text-xs text-blue-700 space-y-1">
                  ...
                  <p className="font-semibold mt-2">Luego agrega el router asÃ­:</p>
                  <code className="block bg-white rounded px-2 py-1 text-blue-800">
